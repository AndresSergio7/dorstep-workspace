...
${refM ? `<div class="sec"><h3>Top 5 agencias — comparativo</h3>${compareBarTable('Agencias', focus.byAgency, refM.byAgency, 5)}</div>` : `<div class="sec"><h3>Tickets por agencia (${esc(focusLabel)})</h3>${barTable(focus.byAgency, 10)}</div>`}
${refM ? `<div class="sec"><h3>Top 5 tipos de error — comparativo</h3>${compareBarTable('Tipos de error', focus.byErrorType, refM.byErrorType, 5)}</div>` : `<div class="sec"><h3>Tipos de error (${esc(focusLabel)})</h3>${barTable(focus.byErrorType, 10)}</div>`}
${focus.activeDepartments > 1 ? (refM ? `<div class="sec"><h3>Tickets por departamento — comparativo</h3>${compareBarTable('Departamentos', focus.byDepartment, refM.byDepartment, 6)}</div>` : `<div class="sec"><h3>Tickets por departamento (${esc(focusLabel)})</h3>${barTable(focus.byDepartment, 8)}</div>`) : ''}
